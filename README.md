...
Current Version: 1.0.1 | [Changelog](NEWS.md)
<!-- badges: start -->
<!-- badges: end -->

**Logan T. Berner, Jakob J. Assmann, Signe Normand and Scott Goetz**

The **lsatTS** package helps you to:
...
**Exporting time-series from the Earth Engine using lsat\_export\_ts()**
...
**Calculate spectral indices using lsat\_calc\_spec\_index()**
