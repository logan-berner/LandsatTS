...
#'
#' @description For each band, this function computes average surface reflectance across neighboring voxels at a sample site.
...
#' @param dt A data.table containing coincident surface reflectance measurements for multiple Landsat pixels at each sample site.
