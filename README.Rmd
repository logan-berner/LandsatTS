...
2. [Prepare and extract Landsat data](#2-prepare-and-extract-Landsat-data)
3. [Cross-calibrate Landsat sensors](#3-cross-calibrate-Landsat-sensors)
...
Logan T. Berner wrote the analysis functions (Sections 3 and 4). Jakob J. Assmann faciliated package development and wrote the extraction and preparation functions (Section 1). Richard Massey wrote the original Python code for the `lsat_export_ts()` function, later refined and translated first to JavaScript and then rgee code by Jakob J. Assmann. Singe Normand and Scoet Goetz provided funding (?) and mentorship for this project. Logan T. Berner and Jakob J. Assmann prepared the code for publication and wrote the documnetation. 
